...
<main>
	<header>
		...
		<p class="sub">
			12 variants of the omni-svelte logo — different colours, techniques, and moods.<br />Pick a
			favourite or combine ideas.
		</p>
	</header>
			...
			<article class="card">
				...
				<div class="info">
					...
					<div class="wordmark-mock">
						...
						<span
							class="wm-text"
							style="background:linear-gradient(90deg, {v.colors[0]}, {v.colors[
								v.colors.length - 1
					...
					<!-- Mini hero mock -->
					<div class="mini-hero">
						<div class="hero-badge" style="color:{v.accent}; border-color:{v.accent}40">
							SvelteKit with superpowers
						</div>
						<button
							style="background:linear-gradient(135deg, {v.colors[0]}, {v.colors[
								v.colors.length - 1
							]}); color:{contrast(v.colors[1] || v.colors[0])}">Get Started</button
						>
					</div>
				</div>
