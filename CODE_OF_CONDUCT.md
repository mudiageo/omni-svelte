...
- Accepting responsibility and apologising when we make mistakes, and learning from the experience
...
- Publishing others' private information (e.g. physical or email address) without their explicit permission
...
This Code of Conduct applies within all community spaces, and also when an individual is officially representing the project in public spaces — for example, using an official email address, posting via an official social media account, or acting as an appointed representative at an event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers at **conduct@omni-svelte.dev** or via a [private GitHub message](https://github.com/mudiageo).
