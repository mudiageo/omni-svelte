...
program
	...
	.option('-o, --output <path>', 'Custom output directory or file path')
	...
	.option('--only <ops>', 'Comma-separated subset for remote functions (e.g. list,get)')
	.option('--with <relations>', 'Comma-separated relationships to eager-load')
	.option('--no-auth', 'Skip generating an authorize stub')
