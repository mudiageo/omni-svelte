...
export class PathResolver {
	...
	getModelBaseImportPath(modelPath: string): string {
		// Use omni-svelte package import for consuming apps
		return 'omni-svelte/model';
	}
	...
	toImportPath(relativePath: string): string {
		// Handle package imports - don't add ./ prefix or modify them
		if (relativePath.startsWith('omni-svelte')) {
			return relativePath;
		}
